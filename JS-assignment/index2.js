import { computePosition, offset, flip, shift } from 'https://cdn.jsdelivr.net/npm/@floating-ui/dom@latest/+esm';
...
reference.addEventListener('mouseenter', () => showFloatingElement(floating3, 'right'));
reference.addEventListener('mouseleave', () => {
